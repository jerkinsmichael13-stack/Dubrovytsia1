    ...
    try {
        ...
        const response = await fetch(GOOGLE_SCRIPT_URL, {
            ...
            body: JSON.stringify({
                ...
                period: photoData.period,
                category: photoData.category,
                date: photoData.date || new Date().toLocaleDateString('uk-UA')
            })
        });
        ...
        if (data.status === 'success') {
            console.log('✅ Фото успішно додано в Google Sheets!');
        }
...
function initPhotoGallery() {
    ...
    // Завантажуємо фото (з Google Sheets або демо-дані)
    loadPhotosFromGoogle().then(function(photos) {
        allPhotos = photos;
        console.log('✅ Завантажено', allPhotos.length, 'фотографій');
        ...
        // У разі помилки використовуємо демо-дані
